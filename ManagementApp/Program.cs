...
using ManagementApp.Services.Scheduled;
...
var sentryEnvironment = Environment.GetEnvironmentVariable("SentryEnvironment") ?? "Management-App@1.142.production";
...
builder.Services.AddSingleton<ManagementApp.Services.Helpers.WordFilter>();

...
namespace LuminaryVisuals.Migrations
{
    ...
    [Migration("20250505151331_BetterIndexingImprovingChat")]
    partial class BetterIndexingImprovingChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.BlockedWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.ColumnPreset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ColumnPresets");
                });

            modelBuilder.Entity("LuminaryVisuals.Data.Entities.DataProtectionKey", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.PayoneerSettings", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("character varying(255)");
                    ...
                    b.ToTable("PayoneerSettings");
                });

            modelBuilder.Entity("LuminaryVisuals.Data.Entities.QuickMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.UserNotificationStatus", b =>
                {
            ...
            modelBuilder.Entity("Project", b =>
                {
                    ...
                    b.HasIndex("IsArchived", "InternalOrder");

                    b.HasIndex("IsArchived", "PrimaryEditorId", "SecondaryEditorId");
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.PayoneerSettings", b =>
                {
                    b.HasOne("LuminaryVisuals.Data.Entities.ApplicationUser", "User")
                        .WithOne("PayoneerSettings")
                        .HasForeignKey("LuminaryVisuals.Data.Entities.PayoneerSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.UserNotificationStatus", b =>
                {
                    b.HasOne("LuminaryVisuals.Data.Entities.Notification", "Notification")
                        .WithMany("UserNotificationStatuses")
            ...
            modelBuilder.Entity("LuminaryVisuals.Data.Entities.Notification", b =>
                {
                    b.Navigation("UserNotificationStatuses");
                });
